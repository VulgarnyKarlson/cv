...
\\  Опыт работы с высоконагруженными проектами (до 500к rps), и с большим кол. пользователей (до 1 миллиона)
}
...
\begin{rSection}{\textbf{Опыт работы} (6 лет) }
    ...
    \begin{itemize}
        ...
        \item Увеличил годовую прибыль проекта \textbf{с 0 до 1 млн\$} в течение 2 лет, при работе под \textbf{нагрузкой в 500к} rps\@.
    \end{itemize}
