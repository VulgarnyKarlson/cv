...
\headline{Senior Software Engineer with experience in: Node.js, Go, Database, Team \& Tech Leadership}
\begin{document}
%----------------------------------------------------------------------------------------
...
\\ With load under \textbf{500k} rps(input), and  number of users (up to \textbf{1 million})
